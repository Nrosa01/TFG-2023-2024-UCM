...
struct ParticleDefinition
{
	...
	ParticleDefinition(std::string text_id, ParticleProject::colour_t particle_color, int16_t random_granularity, std::vector<ParticleProject::Vector2D> movement_passes, Properties properties, std::vector<Interaction> interactions) :
		text_id(text_id),
