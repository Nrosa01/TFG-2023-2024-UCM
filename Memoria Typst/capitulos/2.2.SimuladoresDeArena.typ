...
A mayor sea el tamaño de la matriz que represente el estado de un autómata celular, menor será el rendimiento, ya que procesar las reglas de evolución de cada una de las celdas de manera secuencial, que es la manera de ejecución de una CPU, llega a resultar muy costoso a medida que aumenta el número de celdas. Sin embargo, se puede aprovechar una particularidad de los autómatas celulares, y es que el cálculo de evolución de cada celda es independiente del cálculo de evolución del resto de celdas. Este tipo de problemas se conoce comúnmente como 'Embarrassingly parallel', problemas donde la sub-separación de una tarea grande en tareas muy pequeñas independientes entre ellas es obvia o directa.
